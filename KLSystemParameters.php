...
// -------------------------------------
		...
		if ($_SESSION['PTADUSecondaryBanksMax'] != $_POST['X_PTADUSecondaryBanksMax']) {
			$SQL[] = "UPDATE klconfig SET confvalue = '" . $_POST['X_PTADUSecondaryBanksMax'] . "'	WHERE confname = 'PTADUSecondaryBanksMax'";
		}
		...
		if ($_SESSION['PTSMHSecondaryBanksMax'] != $_POST['X_PTSMHSecondaryBanksMax']) {
			$SQL[] = "UPDATE klconfig SET confvalue = '" . $_POST['X_PTSMHSecondaryBanksMax'] . "' WHERE confname = 'PTSMHSecondaryBanksMax'";
		}
